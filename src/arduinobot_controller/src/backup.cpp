...
// namespace cartesianbot_controller
// {
//     CartesianbotInterface::CartesianbotInterface()
//     {
//     }
...
//     CallbackReturn CartesianbotInterface::on_init(const hardware_interface::HardwareInfo &hardware_info)
//     {
//         CallbackReturn result = hardware_interface::SystemInterface::on_init(hardware_info);
//         if (result != CallbackReturn::SUCCESS)
//         {
...
//         catch (const std::out_of_range &e)
//         {
//             RCLCPP_FATAL(rclcpp::get_logger("CartesianbotInterface"), "No Serial Port provided! Aborting");
//             return CallbackReturn::FAILURE;
//         }
...
//     std::vector<hardware_interface::StateInterface> CartesianbotInterface::export_state_interfaces()
//     {
//         std::vector<hardware_interface::StateInterface> state_interfaces;

//         // Provide position interfaces for X, Y, Z axes
//         for (size_t i = 0; i < info_.joints.size(); i++)
//         {
//             state_interfaces.emplace_back(hardware_interface::StateInterface(
//                 info_.joints[i].name, hardware_interface::HW_IF_POSITION, &position_states_[i]));
...
//     std::vector<hardware_interface::CommandInterface> CartesianbotInterface::export_command_interfaces()
//     {
//         std::vector<hardware_interface::CommandInterface> command_interfaces;
...
//     CallbackReturn CartesianbotInterface::on_activate(const rclcpp_lifecycle::State &previous_state)
//     {
//         RCLCPP_INFO(rclcpp::get_logger("CartesianbotInterface"), "Starting robot hardware ...");

//         // Reset commands and states for X, Y, Z axes
...
//     CallbackReturn CartesianbotInterface::on_deactivate(const rclcpp_lifecycle::State &previous_state)
//     {
//         RCLCPP_INFO(rclcpp::get_logger("CartesianbotInterface"), "Stopping robot hardware ...");
...
//     hardware_interface::return_type CartesianbotInterface::read(const rclcpp::Time &time,
//                                                                 const rclcpp::Duration &period)
//     {
...
//     hardware_interface::return_type CartesianbotInterface::write(const rclcpp::Time &time,
//                                                                  const rclcpp::Duration &period)
//     {
//         if (position_commands_ == prev_position_commands_)
//         {
...
// PLUGINLIB_EXPORT_CLASS(cartesianbot_controller::CartesianbotInterface, hardware_interface::SystemInterface)